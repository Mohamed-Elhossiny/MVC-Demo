...
namespace Lab.Controllers
{
    public class InstructorController : Controller
    {
        ...
        public IActionResult Search(string name)
        {
            if (name != null)
            {
                //Instructor instructor = db.Instructors.FirstOrDefault(i => i.Name == name);
        ...
        {
            //if (instructor.Name != null && instructor.Dept_Id != null && instructor.Course_Id != null)
        ...
        {
            //if (ins.Name != null && ins.Dept_Id != null && ins.Course_Id != null)
            if(ModelState.IsValid==true)
            {
